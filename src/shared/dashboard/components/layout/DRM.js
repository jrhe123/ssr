                ...
                <div style={bodyContainerStyle}>
                    <div style={channelSearchContainerStyle}>
                        ...
                        <div style={channelInfoContainerStyle}>
                            <div style={safeguardInfoStyle} onClick={() => this.handleSessionOption()}>
                                <p style={safeguardInfoLabelStyle}>Restrict users to have a maximum number of sessions</p>
                            </div>
                            <div style={safeguardInfoStyle} onClick={() => this.handleDomainSignup()}>
                                <p style={safeguardInfoLabelStyle}>Allow specific email domains to signup</p>
                            </div>
                            <div style={safeguardInfoStyle} onClick={() => this.handlePrivateChannel()}>
                                <p style={safeguardInfoLabelStyle}>Enable Invite codes for private channels</p>
                            </div>
                            <div style={safeguardInfoStyle} onClick={() => this.handleSpecificAccess()}>
                                <p style={safeguardInfoLabelStyle}>Manage users from accessing specific channel</p>
                            </div>
                            <div style={safeguardInfoStyle} onClick={() => this.handleRemoveUser()}>
                                <p style={safeguardInfoLabelStyle}>Remove users & wipe downloaded content</p>
                            </div>
                        </div>
                    </div>
